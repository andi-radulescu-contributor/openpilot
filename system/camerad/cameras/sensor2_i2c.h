...
// enable shutter (waiting on "FSIN" guide from omnivision marketing)
{0x3009, 2},      // 0x3009[2] = 0  (Pad control, bit 2 is disable_fsin_in)
{0x3015, 0x8+2},  // 0x3015[1] = 1  (Pad input enable)
//{0x303F, 2}, // io_pad_in_val = FSIN
//{0x3210, 0x10},   // FSIN enable?
//{0x3822, 0x13},
...
{0x320e, 0x00}, {0x320f, 0x00},
{0x3211, 0x61},
{0x3215, 0xcd},
{0x3219, 0x08},

{0x3506, 0x30}, // hcg fine exposure
{0x350a, 0x01}, {0x350b, 0x00}, {0x350c, 0x00}, // hcg digital gain

{0x3586, 0x60}, // lcg fine exposure
{0x358a, 0x01}, {0x358b, 0x00}, {0x358c, 0x00}, // lcg digital gain

// SPD exposure course, set below
//{0x3541, 0x00}, {0x3542, 0x04},

{0x3548, 0x04}, {0x3549, 0x40}, // other spd gain
{0x354a, 0x01}, {0x354b, 0x00}, {0x354c, 0x00}, // spd digital gain

// VS exposure course, set below
//{0x35c1, 0x00}, {0x35c2, 0x02},

{0x35c6, 0xa0}, // vs fine exposure
...
{0x5e01, 0x09}, {0x5e02, 0x09}, {0x5e03, 0x0a}, {0x5e04, 0x0a},
{0x5e05, 0x0a}, {0x5e06, 0x0b}, {0x5e07, 0x0b}, {0x5e08, 0x0c},
{0x5e09, 0x0c}, {0x5e0a, 0x0d}, {0x5e0b, 0x0d}, {0x5e0c, 0x0e},
{0x5e0d, 0x0e}, {0x5e0e, 0x0f}, {0x5e0f, 0x0f}, {0x5e10, 0x10},
{0x5e11, 0x10}, {0x5e12, 0x11}, {0x5e13, 0x11}, {0x5e14, 0x12},
{0x5e15, 0x12}, {0x5e16, 0x12}, {0x5e17, 0x12}, {0x5e18, 0x13},
{0x5e19, 0x13}, {0x5e1a, 0x13}, {0x5e1b, 0x14}, {0x5e1c, 0x14},
{0x5e1d, 0x14}, {0x5e1e, 0x15}, {0x5e1f, 0x15}, {0x5e20, 0x15},
{0x5e21, 0x16},

// m_ndY_val[0:32]
// 0x200+0xff+0x100*3+0x80*12+0x40*16 = 4095
{0x5e22, 0x00}, {0x5e23, 0x02},
                {0x5e26, 0x00}, {0x5e27, 0xff},
                {0x5e29, 0x01}, {0x5e2a, 0x00},
                {0x5e2c, 0x01}, {0x5e2d, 0x00},
                {0x5e2f, 0x01}, {0x5e30, 0x00},
                {0x5e32, 0x00}, {0x5e33, 0x80},
...
{0x5e4c, 0x00}, {0x5e4d, 0x00}, {0x5e4e, 0x80},
                {0x5e50, 0x00}, {0x5e51, 0x80},
                {0x5e53, 0x00}, {0x5e54, 0x80},
                {0x5e56, 0x00}, {0x5e57, 0x40},
                {0x5e59, 0x00}, {0x5e5a, 0x40},
                {0x5e5c, 0x00}, {0x5e5d, 0x40},
                {0x5e5f, 0x00}, {0x5e60, 0x40},
                {0x5e62, 0x00}, {0x5e63, 0x40},
                {0x5e65, 0x00}, {0x5e66, 0x40},
                {0x5e68, 0x00}, {0x5e69, 0x40},
                {0x5e6b, 0x00}, {0x5e6c, 0x40},
                {0x5e6e, 0x00}, {0x5e6f, 0x40},
                {0x5e71, 0x00}, {0x5e72, 0x40},
                {0x5e74, 0x00}, {0x5e75, 0x40},
                {0x5e77, 0x00}, {0x5e78, 0x40},
                {0x5e7a, 0x00}, {0x5e7b, 0x40},
                {0x5e7d, 0x00}, {0x5e7e, 0x40},
                {0x5e80, 0x00}, {0x5e81, 0x40},
                {0x5e83, 0x00}, {0x5e84, 0x40},
...
{0x5f01, 0x08}, {0x5f02, 0x09}, {0x5f03, 0x0a}, {0x5f04, 0x0b},
{0x5f05, 0x0c}, {0x5f06, 0x0c}, {0x5f07, 0x0c}, {0x5f08, 0x0c},
{0x5f09, 0x0c}, {0x5f0a, 0x0d}, {0x5f0b, 0x0d}, {0x5f0c, 0x0d},
{0x5f0d, 0x0d}, {0x5f0e, 0x0d}, {0x5f0f, 0x0e}, {0x5f10, 0x0e},
{0x5f11, 0x0e}, {0x5f12, 0x0e}, {0x5f13, 0x0f}, {0x5f14, 0x0f},
{0x5f15, 0x10}, {0x5f16, 0x11}, {0x5f17, 0x11}, {0x5f18, 0x12},
{0x5f19, 0x12}, {0x5f1a, 0x13}, {0x5f1b, 0x13}, {0x5f1c, 0x14},
{0x5f1d, 0x14}, {0x5f1e, 0x16}, {0x5f1f, 0x16}, {0x5f20, 0x16},
{0x5f21, 0x08},

{0x5f22, 0x00}, {0x5f23, 0x01},
                {0x5f26, 0x02}, {0x5f27, 0x00},
                {0x5f29, 0x02}, {0x5f2a, 0x00},
                {0x5f2c, 0x02}, {0x5f2d, 0x00},
                {0x5f2f, 0x02}, {0x5f30, 0x00},
                {0x5f32, 0x02}, {0x5f33, 0x00},
{0x5f34, 0x00}, {0x5f35, 0x02}, {0x5f36, 0x00},
{0x5f37, 0x00}, {0x5f38, 0x02}, {0x5f39, 0x00},
{0x5f3a, 0x00}, {0x5f3b, 0x02}, {0x5f3c, 0x00},
{0x5f3d, 0x00}, {0x5f3e, 0x02}, {0x5f3f, 0x00},
{0x5f40, 0x00}, {0x5f41, 0x02}, {0x5f42, 0x00},
{0x5f43, 0x00}, {0x5f44, 0x02}, {0x5f45, 0x00},
{0x5f46, 0x00}, {0x5f47, 0x04}, {0x5f48, 0x00},
{0x5f49, 0x00}, {0x5f4a, 0x04}, {0x5f4b, 0x00},
{0x5f4c, 0x00}, {0x5f4d, 0x04}, {0x5f4e, 0x00},
                {0x5f50, 0x04}, {0x5f51, 0x00},
                {0x5f53, 0x04}, {0x5f54, 0x00},
                {0x5f56, 0x04}, {0x5f57, 0x00},
                {0x5f59, 0x04}, {0x5f5a, 0x00},
                {0x5f5c, 0x04}, {0x5f5d, 0x00},
                {0x5f5f, 0x08}, {0x5f60, 0x00},
                {0x5f62, 0x08}, {0x5f63, 0x00},
                {0x5f65, 0x08}, {0x5f66, 0x00},
                {0x5f68, 0x08}, {0x5f69, 0x00},
                {0x5f6b, 0x08}, {0x5f6c, 0x00},
                {0x5f6e, 0x10}, {0x5f6f, 0x00},
                {0x5f71, 0x10}, {0x5f72, 0x00},
                {0x5f74, 0x10}, {0x5f75, 0x00},
                {0x5f77, 0x10}, {0x5f78, 0x00},
                {0x5f7a, 0x20}, {0x5f7b, 0x00},
                {0x5f7d, 0x20}, {0x5f7e, 0x00},
                {0x5f80, 0x20}, {0x5f81, 0x00},
                {0x5f83, 0x00}, {0x5f84, 0xff},
...
// color balance gains
// blue
{0x5280, 0x03}, {0x5281, 0x88},
{0x5480, 0x03}, {0x5481, 0x88},
{0x5680, 0x03}, {0x5681, 0x88},
{0x5880, 0x03}, {0x5881, 0x88},

// green(blue)
{0x5282, 0x02}, {0x5283, 0x68},
{0x5482, 0x02}, {0x5483, 0x68},
{0x5682, 0x02}, {0x5683, 0x68},
{0x5882, 0x02}, {0x5883, 0x68},

// green(red)
{0x5284, 0x02}, {0x5285, 0x68},
{0x5484, 0x02}, {0x5485, 0x68},
{0x5684, 0x02}, {0x5685, 0x68},
{0x5884, 0x02}, {0x5885, 0x68},

// red
{0x5286, 0x05}, {0x5287, 0x10},
{0x5486, 0x05}, {0x5487, 0x10},
{0x5686, 0x05}, {0x5687, 0x10},
{0x5886, 0x05}, {0x5887, 0x10},
};
...
struct i2c_random_wr_payload init_array_ox03c10[] = {
  ...
  */
  ...
  // color balance gains
  // blue
  {0x5280, 0x04}, {0x5281, 0x0},
  {0x5480, 0x04}, {0x5481, 0x0},
  {0x5680, 0x04}, {0x5681, 0x0},
  {0x5880, 0x04}, {0x5881, 0x0},

  // green(blue)
  {0x5282, 0x02}, {0x5283, 0x66},
  {0x5482, 0x02}, {0x5483, 0x66},
  {0x5682, 0x02}, {0x5683, 0x66},
  {0x5882, 0x02}, {0x5883, 0x66},

  // green(red)
  {0x5284, 0x02}, {0x5285, 0x66},
  {0x5484, 0x02}, {0x5485, 0x66},
  {0x5684, 0x02}, {0x5685, 0x66},
  {0x5884, 0x02}, {0x5885, 0x66},

  // red
  {0x5286, 0x05}, {0x5287, 0x52},
  {0x5486, 0x05}, {0x5487, 0x52},
  {0x5686, 0x05}, {0x5687, 0x52},
  {0x5886, 0x05}, {0x5887, 0x52},
};
